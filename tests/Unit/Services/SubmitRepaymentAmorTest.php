...
class SubmitRepaymentAmorTest extends BaseTestCase
{
    /**
     * @var ContractService
     */
    ...
    public function test_SubmitRepayment_amor_fail()
    {
    ...
    public function test_SubmitRepayment_amor_success_1st()
    {
        $borrowAmount = 1000000;
        $user = User::factory()->create();
        $term = LoanTerm::factory()->create([
    ...
    public function test_SubmitRepayment_amor_success_2nd()
    {
        $borrowAmount = 1000000;
        $user = User::factory()->create();
        $term = LoanTerm::factory()->create([
    ...
    public function test_SubmitRepayment_amor_success_full()
    {
        $borrowAmount = 1000000;
        $user = User::factory()->create();
        $term = LoanTerm::factory()->create([
